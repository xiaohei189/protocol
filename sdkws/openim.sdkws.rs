...
pub struct UserInfoWithEx {
    ...
    pub ex: ::core::option::Option<super::protobuf::StringValue>,
    #[prost(message, optional, tag="7")]
    pub global_recv_msg_opt: ::core::option::Option<super::protobuf::Int32Value>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct JoinGroupApplicationTips {
    ...
    #[prost(message, optional, tag="5")]
    pub request: ::core::option::Option<GroupRequest>,
}
/// 	OnQuitGroup()
...
pub struct FriendApplicationTips {
    /// from: initiator; to: receiver
    #[prost(message, optional, tag="1")]
    pub from_to_user_id: ::core::option::Option<FromToUserId>,
    #[prost(message, optional, tag="2")]
    pub request: ::core::option::Option<FriendRequest>,
}
/// FromUserID accept or reject ToUserID
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct FriendApplicationApprovedTips {
    /// from: the person who agrees; to: the person who initiates the request
    #[prost(message, optional, tag="1")]
    pub from_to_user_id: ::core::option::Option<FromToUserId>,
    #[prost(string, tag="2")]
    pub handle_msg: ::prost::alloc::string::String,
...
pub struct FriendApplicationRejectedTips {
    /// from: rejecter; to: request initiator
    #[prost(message, optional, tag="1")]
    pub from_to_user_id: ::core::option::Option<FromToUserId>,
    #[prost(string, tag="2")]
    pub handle_msg: ::prost::alloc::string::String,
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ConversationDeleteTips {
    #[prost(string, tag="1")]
    pub user_id: ::prost::alloc::string::String,
    #[prost(string, repeated, tag="2")]
    pub conversation_i_ds: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
